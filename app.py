...
from twitter_utils import get_access_token, get_oauth_verifier_url, get_request_token
...
def twitter_login():
    ...
    #redirecting the user to Twitter so they can confirm the authorization
